...
func (m *MockPaymentRepository) CheckIdempotency(ctx context.Context, tx pgx.Tx, idempotencyKey string) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPaymentRepositoryMockRecorder) CheckIdempotency(ctx, tx, idempotencyKey interface{}) *gomock.Call {
...
func (m *MockPaymentRepository) Get(ctx context.Context, paymentID string) (*domain.Payment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, paymentID)
...
func (mr *MockPaymentRepositoryMockRecorder) Get(ctx, paymentID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockPaymentRepository)(nil).Get), ctx, paymentID)
}
...
// Create indicates an expected call of Create.
func (mr *MockPaymentServiceMockRecorder) Create(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Update indicates an expected call of Update.
func (mr *MockPaymentServiceMockRecorder) Update(ctx, paymentID, status interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
